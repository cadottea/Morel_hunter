...
json_folder = "./morel_images"  # Path where your JSON files are located (the same directory as your images)
output_folder = "./yolo_labels"  # Path where your YOLO labels will be saved
...
for json_file in os.listdir(json_folder):
    if json_file.endswith('.json'):
        ...
        for shape in data['shapes']:
            ...
            # Debugging: Print label for each shape
            print(f"Generated YOLO label for shape: {label}")
            print(f"YOLO label: {yolo_label}")
...
print("Finished converting JSON labels to YOLO format.")
